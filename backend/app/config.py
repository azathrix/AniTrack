...
DEFAULT_SETTINGS = {
    ...
    "nfo_output_root": "",
    "series_dir_template": "{title_base}{year_suffix}",
    "season_dir_template": "Season {season:02d}",
    "episode_name_template": "{title_base} - S{season:02d}E{episode:02d} - 第 {episode:02d} 话",
    "movie_name_template": "{title_base}{year_suffix}/{title_base}{year_suffix}",
    "tv_name_template": "{title_base}{year_suffix}/Season {season:02d}/{title_base} - S{season:02d}E{episode:02d} - 第 {episode:02d} 话",
